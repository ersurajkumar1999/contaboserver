            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-primary active">
                    ...
                    <div class="box-body">
                        ...
                        <form class="form" id="details_form" method="post" action="{{ route('install.update') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ENVATO_PURCHASE_CODE" required class="form-control"
                                        id="envato_purchase_code">
                                </div>
                            </div>

                            <div class="col-md-12">
                                <button type="submit" id="install_button" class="btn btn-primary pull-right">I Agree,
                                    Update</button>
                            </div>
                        </form>
                    </div>
