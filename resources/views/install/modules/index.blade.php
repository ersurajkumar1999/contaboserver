                        ...
                        @foreach ($modules as $module)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (!$module['is_installed'])
                                        <a class="btn btn-success btn-xs" @if ($is_demo) href="#"
                                    ...
                                    @else
                                        <a class="btn btn-warning btn-xs" @if ($is_demo) href="#"
                                                                                                                    disabled
                                                                                                                    title="@lang('lang_v1.disabled_in_demo')"
                                                                        @else
                            ...
                            @endif --}}
                                    ...
                                    <form
                                        ...
                                        @method('DELETE')
                                        @csrf
                                        <button class="btn btn-danger btn-xs" @if ($is_demo) disabled="disabled" 
                                ...
                                <td>
                                    ...
                                    @if (!empty($module['version']) && $module['version']['is_update_available'])
                                        <div class="alert alert-warning mt-5">
                                            <i class="fas fa-sync"></i> @lang('lang_v1.module_new_version', ['module' =>
                                            $module['name'], 'link' => $module['update_link']])
                                        </div>
                                    @endif
                                </td>
                            </tr>
