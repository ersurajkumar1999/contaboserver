                        ...
                        <form class="form" id="details_form" method="post" action="{{ route('install.postDetails') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="APP_NAME" id="app_name"
                                        placeholder="OnlineOffice.live POS" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME"
                                        placeholder="OnlineOffice.live POS (Optional)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4  smtp hide">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control smtp_input" id="MAIL_PORT" name="MAIL_PORT"
                                        required disabled>
                                </div>
                            </div>
